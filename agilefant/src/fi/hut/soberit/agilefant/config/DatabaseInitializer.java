...
public class DatabaseInitializer implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        jdbc.update("INSERT INTO users (fullName, loginName, passwd, initials, enabled, recentItemsNumberOfWeeks, role) VALUES (?, ?, ?, ?, ?, ?, ?)",
                "Administrator", "admin", "$2a$10$fkULKc1/AmruYR9HTmh5ROc5692D3WaPidZ7dHz073W33AvU2Vqom", "Admin", 1, 16, "developer");
        jdbc.update("INSERT INTO users (admin, fullName, loginName, passwd, initials, enabled, recentItemsNumberOfWeeks, role) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", 0,
                "readonly", "readonly", "$2a$10$fkULKc1/AmruYR9HTmh5ROc5692D3WaPidZ7dHz073W33AvU2Vqom", "readonly", 1, 0, "developer");
